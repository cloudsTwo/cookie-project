<template>
  ...
  >
    ...
    <div
      class="loginDiv"
      style="text-align:center;background-color:white; height:430px"
    >
      <!-- <div class="logoDiv" >
      ...
      <el-tabs
        ...
        class="tab"
        type="border-card"
        tab-click="font-size:40px"
        style="padding-top:20px;height:400px;padding-left:20px;padding-right:20px;"
      >
        ...
        >
          ...
          <el-form-item
            label="用户名"
            style="padding-top:40px;padding-left:13%;"
          >
            <el-col :span="15">
              <el-input
                v-model="users.name"
        ...
        >
          ...
          <el-col style="text-align:right">
            ...
            <el-link
              ...
              class="registered"
              style="margin-bottom:5px"
              href="http://localhost:8081/#/registered_page"
            >去注册</el-link>
          </el-col>
        </el-tab-pane>
