...
export function findOrderById(oid){
  return request({
...
export function findAllGoodInfo(){
  return request({
    url:'/goodInfo/findAllGoodInfo'
  })
}

export function findOrderByOrderNum(orderNum){
  return request({
    url:'/order/findOrderByOrderNum',
    params:{
      orderNum
    }
  })
...
export function findGoodInfoById(gid){
  return request({
    url:'/goodInfo/findGoodInfoById',
    params:{
      gid
    }
  })
